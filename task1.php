<html>
	...
	<body>
		<div class = "fon"><img src = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Logo-Nsk-Metro.svg/230px-Logo-Nsk-Metro.svg.png"></div>
		<div class = "fon2"><img src = "http://novosibtoday.ru/image/Gerb_Novosibirsk.png"></div>
<?php
	$metro = [
		'Ленинская' => [
			[
